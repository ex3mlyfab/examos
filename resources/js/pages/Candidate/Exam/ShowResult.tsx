        ...
        <div className="min-h-screen bg-muted/20 font-sans py-8 px-4 sm:px-6">
            <div className="max-w-5xl mx-auto space-y-6">
                ...
                <div className="flex items-center space-x-4 mb-4">
                    ...
                    <div>
                        <h2 className="text-3xl font-bold tracking-tight text-primary">Detailed Scorecard</h2>
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>Review answers you submitted for this examination</CardDescription>
                    </CardHeader>
                                    ...
                                    <div className="ml-8 space-y-2">
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                            <div className="p-3 rounded-md bg-background border">
                                                <p className="text-xs text-muted-foreground uppercase font-bold mb-1">Your Answer:</p>
