                ...
                <div className="flex flex-col items-start justify-between gap-4 sm:flex-row sm:items-center">
                    <div>
                        ...
                        <p className="text-muted-foreground">
                            Manage examination subjects and settings.
                        </p>
                    </div>
                ...
                <Card>
                    <CardHeader className="flex flex-row items-center justify-between pb-3">
                        <div>
                            ...
                            <CardDescription>
                                A list of all subjects allocated across exam
                                seasons.
                            </CardDescription>
                        </div>
                        <div className="w-64">
                                    ...
                                    {subjects.data.length === 0 ? (
                                        ...
                                        subjects.data.map((subject) => (
                                            <TableRow key={subject.id}>
                                                ...
                                                <TableCell>
                                                    {
                                                        subject.total_questions_to_display
                                                    }
                                                </TableCell>
                                                <TableCell>
                                                    <span
                                                        className={`inline-flex items-center rounded-full px-2.5 py-0.5 text-xs font-semibold ${subject.is_active ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'}`}
                                                    >
                                                        {subject.is_active
                                                            ? 'Active'
                                                            : 'Inactive'}
...
Index.layout = {
    breadcrumbs: [{ title: 'Subjects', href: '/admin/subjects' }],
};
