            ...
            <div className="flex h-full flex-1 flex-col gap-4 overflow-x-auto rounded-xl p-4 max-w-5xl mx-auto w-full">
                <div className="flex items-center gap-4 mb-4">
                    ...
                    <div>
                        ...
                        <p className="text-muted-foreground">Modify this multiple-choice question and its options.</p>
                    </div>
                </div>
                            ...
                            <Card>
                                ...
                                <CardContent>
                                    ...
                                    <div className="space-y-4 mt-6 border-t pt-4">
                                        <Label htmlFor="image" className="text-base">Image Attachment</Label>
                                        
                                        {question.image_path && !data.remove_image && (
                                            <div className="mb-4 relative w-64 rounded-md border p-2">
                                                <img src={`/storage/${question.image_path}`} alt="Question visual" className="w-full h-auto rounded-md" />
                                                <div className="flex items-center gap-2 mt-2">
                                                    ...
                                                    />
                                                    <Label htmlFor="remove_image" className="text-sm text-destructive cursor-pointer">Remove image</Label>
                                                </div>
                                            </div>
                                        )}

                                        <div className="space-y-2">
                                            <Label htmlFor="image" className="text-sm">Upload New Image (replaces existing)</Label>
                                            <Input
                                                id="image"
                                                type="file"
                                                accept="image/*"
