...
export default function Edit({ season }: PageProps) {
    const { data, setData, put, processing, errors } = useForm({
        ...
        starts_at: season.starts_at ? new Date(season.starts_at).toISOString().slice(0, 16) : '',
        ends_at: season.ends_at ? new Date(season.ends_at).toISOString().slice(0, 16) : '',
        ...
        <>
            ...
            <div className="flex h-full flex-1 flex-col gap-4 overflow-x-auto rounded-xl p-4 max-w-4xl mx-auto w-full">
                <div className="flex items-center gap-4 mb-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold tracking-tight">Edit Exam Season</h1>
                        <p className="text-muted-foreground">Modify an existing examination period.</p>
                    </div>
                </div>
                ...
                <form onSubmit={submit}>
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>Update the details of this exam season.</CardDescription>
                        </CardHeader>
