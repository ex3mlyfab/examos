...
export default function Edit({ candidate, seasons }: PageProps) {
    const { data, setData, put, processing, errors } = useForm({
        exam_season_id: candidate.exam_season_id ? candidate.exam_season_id.toString() : '',
            ...
            <div className="flex h-full flex-1 flex-col gap-4 overflow-x-auto rounded-xl p-4 max-w-4xl mx-auto w-full">
                <div className="flex items-center gap-4 mb-4">
                    ...
                    <div>
                        ...
                        <p className="text-muted-foreground">Modify candidate details.</p>
                    </div>
                </div>
                ...
                <form onSubmit={submit}>
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                Update the candidate's personal and academic information. Note that editing names/phones does not reset the automatically generated password.
                            </CardDescription>
                        </CardHeader>
                        <CardContent className="space-y-6">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div className="space-y-2">
                                    <Label htmlFor="file_no">File Number (Username) <span className="text-destructive">*</span></Label>
                                    <Input
                                        id="file_no"
                                        value={data.file_no}
                                        ...
                                        autoFocus
                                    />
                                    {errors.file_no && <p className="text-sm font-medium text-destructive">{errors.file_no}</p>}
                                </div>
                                <div className="space-y-2">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div className="space-y-2">
                                    ...
                                    />
                                    {errors.telephone && <p className="text-sm font-medium text-destructive">{errors.telephone}</p>}
                                </div>
                                <div className="space-y-2">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                ...
                                <div className="space-y-2">
                                    ...
                                    />
                                    {errors.level && <p className="text-sm font-medium text-destructive">{errors.level}</p>}
                                </div>
                            </div>
                            ...
                            <div className="flex items-center justify-between rounded-lg border p-4">
                                <div className="space-y-0.5">
                                    ...
                                    <p className="text-sm text-muted-foreground">
                                        Active candidates can log in to the portal and take exams.
                                    </p>
                                </div>
                                <Switch
