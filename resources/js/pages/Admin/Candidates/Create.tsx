            ...
            <div className="flex h-full flex-1 flex-col gap-4 overflow-x-auto rounded-xl p-4 max-w-4xl mx-auto w-full">
                <div className="flex items-center gap-4 mb-4">
                    ...
                    <div>
                        ...
                        <p className="text-muted-foreground">Register a new candidate for an exam season.</p>
                    </div>
                </div>
                ...
                <form onSubmit={submit}>
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                Candidate password will be automatically generated using their First Name and Last 4 digits of their Phone Number.
                            </CardDescription>
                        </CardHeader>
